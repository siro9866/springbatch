...
import com.sil.springbatch.repository.WinRepository;
...
public class SecondBatch {
    ...
    public SecondBatch(JobRepository jobRepository, PlatformTransactionManager transactionManager, WinRepository winRepository) {
